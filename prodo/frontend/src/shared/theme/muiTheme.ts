// ==========================================================================
// MUI Theme — built from design tokens (TypeScript)
// ==========================================================================

// --------------------------------------------------------------------------
// Module augmentation — custom palette, typography, and grey overrides
// --------------------------------------------------------------------------
...
declare module '@mui/material/styles' {
  ...
  // Use Record<string, any> to allow @media queries in typography variants
  type CustomTypographyStyle = React.CSSProperties & Record<string, any>;

  interface TypographyVariants {
    displayLarge: CustomTypographyStyle;
    displaySmall: CustomTypographyStyle;
    code: CustomTypographyStyle;
    paragraphLarge: CustomTypographyStyle;
    paragraphXSmall: CustomTypographyStyle;
    navigationItem: CustomTypographyStyle;
    smallText: CustomTypographyStyle;
    tinyText: CustomTypographyStyle;
  }
  ...
  // grey uses palette.scale which has non-standard keys (1000, 1100, 1200).
  // Access via (theme.palette.grey as any)[1000] when needed.
}
...
export function createAppTheme(mode: 'dark' | 'light' = 'dark') {
  ...
  return createTheme({
    ...
    zIndex: {
      mobileStepper: 1000, fab: 1050, speedDial: 1050,
      ...
      MuiSwitch: {
        styleOverrides: {
          root: {
            ...
            '& .MuiSwitch-thumb': { width: 20, height: 20, boxShadow: '0 2px 4px rgba(0,0,0,0.2)' },
            '& .MuiSwitch-track': {
              borderRadius: 12,
