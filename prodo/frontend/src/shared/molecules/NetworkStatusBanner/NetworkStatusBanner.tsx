...
const RetryIcon = RefreshIcon
const OnlineIcon = WifiIcon
const OfflineIcon = WifiOffIcon
const ServerDownIcon = CloudOffIcon
import {
  Box,
  Button,
  Collapse,
...
export function NetworkStatusBanner({ onRetry }: NetworkStatusBannerProps) {
  ...
  const [status, setStatus] = useState<NetworkStatusType>(NetworkStatus.ONLINE)
