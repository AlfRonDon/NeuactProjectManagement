...
type BreadcrumbEntry = string | BreadcrumbItem
...
interface PageHeaderProps extends Omit<BoxProps, 'title'> {
  ...
  actions?: ReactNode
  breadcrumbs?: BreadcrumbEntry | BreadcrumbEntry[] | null
  children?: ReactNode
  sx?: SxProps<Theme>
...
const toArray = (value: BreadcrumbEntry | BreadcrumbEntry[] | null | undefined): BreadcrumbEntry[] =>
  Array.isArray(value) ? value : value ? [value] : []

function renderCrumb(crumb: BreadcrumbEntry, index: number): ReactNode {
