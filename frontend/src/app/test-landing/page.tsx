...
import {
  ...
  ArrowUpRight, Zap, Flame, CheckCircle2, Bell,
  Mic, ChevronRight, TrendingUp,
...
const PROJECTS = [
  { id: "1", name: "Command Center v5", short: "CCv5", progress: 20, done: 2,  total: 10, active: 3, blocked: 1, target: "2026-07-31", start: "2026-04-01", color: "#3b82f6", colorCls: "bg-blue-400",   textCls: "text-blue-400"   },
  { id: "2", name: "NeuractReport v3",  short: "NRv3", progress: 33, done: 2,  total: 6,  active: 2, blocked: 0, target: "2026-06-01", start: "2026-03-15", color: "#8b5cf6", colorCls: "bg-violet-400", textCls: "text-violet-400" },
  { id: "3", name: "Spot Particle",     short: "Spot", progress: 50, done: 3,  total: 6,  active: 1, blocked: 1, target: "2026-04-30", start: "2026-03-01", color: "#f59e0b", colorCls: "bg-amber-400",  textCls: "text-amber-400"  },
];

const NOTIFICATIONS = [
  { id: "n1", cat: "blocker",  title: "Phase C blocked by Phase B",        desc: "Dependency unresolved for 3 days. Phase B still in progress — no handoff scheduled.", project: "CCv5",  from: "System", time: "12m",  read: false, actions: ["escalate","reassign"] },
  { id: "n2", cat: "blocker",  title: "Deploy pipeline failing on staging", desc: "CI job #482 timed out on integration tests. Last green run was 2 days ago.",         project: "CCv5",  from: "CI Bot", time: "34m",  read: false, actions: ["escalate","snooze"] },
  { id: "n3", cat: "overdue",  title: "Widget Renderer overdue by 2 days",  desc: "No status update since Apr 14. Owner: Rohith. No blockers logged.",                   project: "CCv5",  from: "System", time: "1h",   read: false, actions: ["reassign","snooze"] },
  { id: "n4", cat: "mention",  title: "@you in PR #87 review",              desc: "Priya: 'Should we use grid-template-areas or manual placement for the bento?'",        project: "CCv5",  from: "Priya",  time: "45m",  read: false, actions: ["approve","snooze"] },
  { id: "n5", cat: "ai",       title: "Suggest: parallelize Widget + Grid", desc: "No hard dependency between Widget Renderer and Grid Pack. Running in parallel saves ~5 days.", project: "CCv5", from: "AI", time: "5m", read: false, actions: ["approve","snooze"] },
  { id: "n6", cat: "ai",       title: "Risk: single-contributor bottleneck", desc: "Rohith owns 67% of in-progress tasks. Bus factor is 1. Consider redistribution.",   project: "CCv5",  from: "AI",     time: "1h",   read: true,  actions: ["approve","snooze"] },
  { id: "n7", cat: "overdue",  title: "E2E test plan not started",          desc: "Scheduled start Apr 15. Still in backlog. Release is 11 weeks away.",                  project: "CCv5",  from: "System", time: "2h",   read: true,  actions: ["reassign","escalate"] },
  { id: "n8", cat: "mention",  title: "@you tagged in sprint retro",        desc: "Arjun: 'Action item: investigate vLLM memory spike on Phase A.'",                     project: "NRv3",  from: "Arjun",  time: "3h",   read: true,  actions: ["snooze"] },
];

const FOCUS_TASK = { title: "Implement Phase B — Fill/RAG", due: "2026-04-25", est: "16h", project: "CCv5" };
const TODAY = new Date("2026-04-11");

// All tasks across all projects
const ALL_TASKS = [
  { id: "t1",  title: "Implement Phase B — Fill/RAG",     project: "CCv5", status: "active",  due: "2026-04-25", est: "16h", priority: "high"   },
  { id: "t2",  title: "Fix bento grid overflow bug",       project: "CCv5", status: "active",  due: "2026-04-11", est: "2h",  priority: "urgent" },
  { id: "t3",  title: "Phase C — Grid Pack",               project: "CCv5", status: "blocked", due: "2026-05-10", est: "12h", priority: "high"   },
  { id: "t4",  title: "Widget renderer PR merge",          project: "CCv5", status: "active",  due: "2026-04-11", est: "1h",  priority: "urgent" },
  { id: "t5",  title: "Write RAG integration tests",       project: "CCv5", status: "todo",    due: "2026-04-22", est: "4h",  priority: "medium" },
  { id: "t6",  title: "Deploy pipeline fix on staging",    project: "CCv5", status: "blocked", due: "2026-04-13", est: "3h",  priority: "high"   },
  { id: "t7",  title: "Write unit tests for Phase B",      project: "CCv5", status: "todo",    due: "2026-04-22", est: "6h",  priority: "medium" },
  { id: "t8",  title: "Update API auth header handling",   project: "NRv3", status: "active",  due: "2026-04-12", est: "1h",  priority: "urgent" },
  { id: "t9",  title: "API schema approval",               project: "NRv3", status: "active",  due: "2026-04-12", est: "2h",  priority: "high"   },
  { id: "t10", title: "Setup vLLM config",                 project: "NRv3", status: "done",    due: "2026-04-08", est: "3h",  priority: "medium" },
  { id: "t11", title: "E2E test plan",                     project: "NRv3", status: "todo",    due: "2026-05-01", est: "8h",  priority: "low"    },
  { id: "t12", title: "Spot particle spawn fix",           project: "Spot", status: "active",  due: "2026-04-15", est: "3h",  priority: "high"   },
  { id: "t13", title: "Particle engine memory leak",       project: "Spot", status: "blocked", due: "2026-04-20", est: "5h",  priority: "high"   },
  { id: "t14", title: "Audio feedback integration",        project: "Spot", status: "todo",    due: "2026-04-28", est: "4h",  priority: "medium" },
  { id: "t15", title: "Phase A — Understand (complete)",   project: "CCv5", status: "done",    due: "2026-04-05", est: "8h",  priority: "high"   },
  { id: "t16", title: "Schema design finalized",           project: "CCv5", status: "done",    due: "2026-04-07", est: "4h",  priority: "medium" },
];
...
const totalTodo    = totalTasks - totalDone - totalActive - totalBlocked;
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-[3] overflow-y-auto border-r border-neutral-100">
          ...
          {filtered.map(n => {
            ...
            return (
              <div key={n.id}
                onClick={() => { setSel(n.id); setNotifs(prev => prev.map(x => x.id === n.id ? { ...x, read: true } : x)); }}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="ml-auto flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        {n.actions.slice(0, 2).map(a => {
                          ...
                          return (
                            <button key={a} onClick={e => { e.stopPropagation(); setNotifs(prev => prev.map(x => x.id === n.id ? { ...x, read: true } : x)); }}
...
const nearestDeadline = [...PROJECTS].sort((a, b) => daysLeft(a.target) - daysLeft(b.target))[0];
...
const soonestTotalDays = Math.ceil((new Date(soonestProj.target).getTime() - new Date(soonestProj.start).getTime()) / 86400000);
const soonestElapsed   = Math.ceil((TODAY.getTime() - new Date(soonestProj.start).getTime()) / 86400000);
const soonestTimePct   = Math.round(Math.min(100, (soonestElapsed / soonestTotalDays) * 100));
const paceDelta        = soonestProj.progress - soonestTimePct; // positive = ahead
