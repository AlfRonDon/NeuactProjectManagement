...
- Name: tests/widgets.spec.ts >> Widget Rendering & Functionality >> should load test-layouts page with all widgets
- Location: tests/widgets.spec.ts:7:7

# Error details

```
TypeError: _page$textContent.includes is not a function
```
    ...
    - generic [ref=e12]:
      ...
      - generic [ref=e18]:
        ...
        - link "Forgot Password?" [ref=e32] [cursor=pointer]:
          - /url: /keycloak/realms/neuract-project-management/login-actions/reset-credentials?client_id=neuact-pm&tab_id=wVB-D_GfZLQ&client_data=eyJydSI6Imh0dHA6Ly9sb2NhbGhvc3Q6MzQyMC90ZXN0LWxheW91dHMvIiwicnQiOiJjb2RlIiwicm0iOiJmcmFnbWVudCIsInN0IjoiMTJiMmE4NzEtYjU0My00ZjhlLWE3ZTEtNzY2ZWJiNDJkZmQyIn0
